# SQL
В директориях Task, расположены скрипты с кодом запросов к БД и их результаты. Ниже приведены скрипты, которые использались для создания БД и наполнения данными.
## Task 1
